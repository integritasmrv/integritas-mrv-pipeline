...
async def chatwoot_webhook(request: Request):
    try:
        ...
        if not needs_retrieval(user_message):
            ...
            # Check cache
            ck = cache_key_fn(user_message, "rag")
...
Producten:
- Energywall G1: Lithium-vrije residentiële energieopslag met grafeen supercapacitor technologie

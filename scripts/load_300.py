#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Load BE KBO Extract 300 into versioned database"""
import sys
import logging
import psycopg2
import csv
...
class Loader:
    ...
    def load(self, version):
        ...
        tables = {
            ...
            "establishment": ["EstablishmentNumber", "EnterpriseNumber", "StartDate", "EntityForm"],
            ...
            "branch": ["Id", "EnterpriseNumber", "Reference", "Type", "StartDate"],
